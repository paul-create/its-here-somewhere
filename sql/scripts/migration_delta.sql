...
connection to server at "its-here-somewhere-postgres.chqokc88qwim.eu-west-2.rds.amazonaws.com" (35.176.189.64), port 5432 failed: FATAL:  no pg_hba.conf entry for host "4.236.89.82", user "postgresql", database "its_here_somewhere", no encryption
